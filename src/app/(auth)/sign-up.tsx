...
const index=()=>{
    ...
    <View style={styles.container}>
        ...
        <Button onPress={onSubmit} disabled={loading} text={loading?"Creating an account...":"Create an account"}/>
        <Text style={styles.textButton} onPress={()=>router.push('/(auth)/')}>Sign in</Text>
    </View>
    )
 }
